...
public final class RegistrationServiceGrpc {
  ...
  public static final String SERVICE_NAME = "fer.rassus.lab1.client.RegistrationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<fer.rassus.lab1.client.RegistrationRequest,
      fer.rassus.lab1.client.RegistrationResponse> getRegisterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "register",
      requestType = fer.rassus.lab1.client.RegistrationRequest.class,
      responseType = fer.rassus.lab1.client.RegistrationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<fer.rassus.lab1.client.RegistrationRequest,
      fer.rassus.lab1.client.RegistrationResponse> getRegisterMethod() {
    io.grpc.MethodDescriptor<fer.rassus.lab1.client.RegistrationRequest, fer.rassus.lab1.client.RegistrationResponse> getRegisterMethod;
      ...
      synchronized (RegistrationServiceGrpc.class) {
        if ((getRegisterMethod = RegistrationServiceGrpc.getRegisterMethod) == null) {
          RegistrationServiceGrpc.getRegisterMethod = getRegisterMethod =
              io.grpc.MethodDescriptor.<fer.rassus.lab1.client.RegistrationRequest, fer.rassus.lab1.client.RegistrationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "register"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fer.rassus.lab1.client.RegistrationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fer.rassus.lab1.client.RegistrationResponse.getDefaultInstance()))
  ...
  public static abstract class RegistrationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void register(fer.rassus.lab1.client.RegistrationRequest request,
        io.grpc.stub.StreamObserver<fer.rassus.lab1.client.RegistrationResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                fer.rassus.lab1.client.RegistrationRequest,
                fer.rassus.lab1.client.RegistrationResponse>(
  ...
  public static final class RegistrationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RegistrationServiceBlockingStub> {
    ...
    /**
     */
    public fer.rassus.lab1.client.RegistrationResponse register(fer.rassus.lab1.client.RegistrationRequest request) {
  ...
  public static final class RegistrationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RegistrationServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<fer.rassus.lab1.client.RegistrationResponse> register(
        fer.rassus.lab1.client.RegistrationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER:
          serviceImpl.register((fer.rassus.lab1.client.RegistrationRequest) request,
              (io.grpc.stub.StreamObserver<fer.rassus.lab1.client.RegistrationResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class RegistrationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return fer.rassus.lab1.client.Registration.getDescriptor();
    }
